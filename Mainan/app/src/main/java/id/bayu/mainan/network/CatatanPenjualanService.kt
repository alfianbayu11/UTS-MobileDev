package id.bayu.mainan.network

import id.bayu.mainan.activity.data_barang.data.ResultDataBarang
import id.bayu.mainan.activity.login.data.ResultLogin
import id.bayu.mainan.activity.penjualan.data.ResultKeranjang
import id.bayu.mainan.activity.penjualan.data.ResultSearchBarang
import id.bayu.mainan.activity.report.detail.data.ResultItemKeranjang
import id.bayu.mainan.response.ResultSimple
